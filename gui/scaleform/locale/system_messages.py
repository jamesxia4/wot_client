...
class SYSTEM_MESSAGES(object):
    ...
    CHANGEDIVISION_REQUEST_CHANGEDIVISION = '#system_messages:changeDivision/request/changeDivision'
    CHANGEDIVISION_REQUEST_DIVISIONTYPE_MIDDLE = '#system_messages:changeDivision/request/divisionType/MIDDLE'
    CHANGEDIVISION_REQUEST_DIVISIONTYPE_CHAMPION = '#system_messages:changeDivision/request/divisionType/CHAMPION'
    CHANGEDIVISION_REQUEST_DIVISIONTYPE_ABSOLUTE = '#system_messages:changeDivision/request/divisionType/ABSOLUTE'
    ...
    CHANGEDIVISION_REQUEST_DIVISIONTYPE_ENUM = (CHANGEDIVISION_REQUEST_DIVISIONTYPE_MIDDLE, CHANGEDIVISION_REQUEST_DIVISIONTYPE_CHAMPION, CHANGEDIVISION_REQUEST_DIVISIONTYPE_ABSOLUTE)
    ...
    all_ENUM = (REPAIR_SUCCESS,
     ...
     PREBATTLE_REQUEST_NAME_SET_ES_VEHICLE_LIST,
     PREBATTLE_REQUEST_NAME_CHANGE_ES_TYPE,
     CHANGEDIVISION_REQUEST_CHANGEDIVISION,
     CHANGEDIVISION_REQUEST_DIVISIONTYPE_MIDDLE,
     CHANGEDIVISION_REQUEST_DIVISIONTYPE_CHAMPION,
     CHANGEDIVISION_REQUEST_DIVISIONTYPE_ABSOLUTE,
    ...
    @staticmethod
    def changedivision_request_divisiontype(key):
        outcome = '#system_messages:changeDivision/request/divisionType/%s' % key
        if outcome not in SYSTEM_MESSAGES.CHANGEDIVISION_REQUEST_DIVISIONTYPE_ENUM:
            LOG_WARNING('locale key "' + outcome + '" was not found')
            return None
        return outcome
