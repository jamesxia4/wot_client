#Embedded file name: scripts/client/gui/shared/server_events/conditions.py
import weakref
import operator
                ...
                if self._id in children:
                    for qID in children[self._id]:
                        ...
                        if quest is not None:
                            ...
                            result.append(formatters.packTextBlock(label, questID=qID, isAvailable=isAvailable, battlesLeft=battlesLeft))
                        else:
